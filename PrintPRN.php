...
<body>
    ...
    <h1>How to directly Print PRN Commands without Preview or Printer Dialog</h1>
    ...
    $printPRNControllerAbsoluteURL = substr($currentAbsoluteURL, 0, strrpos($currentAbsoluteURL, '/')).'/PrintPRNController.php';
