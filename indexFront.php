...
<html>
	...
	<body>
		<div class="container">
		  	<div class="menu">
		 		<img
					src="frontend/src/assets/playground_assets/logo-1000h.png"
		      		alt="image"
		      		logo_src="frontend/src/assets/playground_assets/logo-1000h.png"
		      		class="logo"
		    	/>
		    <svg viewBox="0 0 1024 1024" class="home">
		      	<path
		    ...
		    <svg viewBox="0 0 1024 1024" class="group-order">
		      	<path
		    ...
		    <svg viewBox="0 0 1024 1024" class="customer">
		      	<path
		  	...
		  	<div class="container1">
		    	<div class="header">
		      		<div class="status">
		        		<div class="all-order">
		          			<svg viewBox="0 0 1024 1024" class="icon03">
		            			<path
		          			...
		          			<span class="text"><span>All Orders</span></span>
		        		</div>
		        		<div class="to-pay">
		          			<svg viewBox="0 0 1024 1024" class="icon07">
		            			<path
